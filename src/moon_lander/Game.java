...
public class Game {
   ...
   /**
    ...
    public void UpdateGame(long gameTime, Point mousePosition)
    {
        ...
        if(playerRocket.box().bottom() - 10 > landingArea.y)
        {
            // Here we check if the rocket is over landing area.
            if((playerRocket.box().left() > landingArea.x) &&
                    (playerRocket.box().left() < landingArea.x + landingArea.landingAreaImgWidth - playerRocket.getWidth()))
            {
